...
# ===================================
# 5. Readjusting the rows of a matrix
# ===================================
...
# =========================================
# 6. Readjusting the components of a vector
# =========================================
def readjust_vect(v):
    s = v.sum()
    if s < 1.0:
...
# ===========================================
# 7. Construction of a customer's initial HMM
# ===========================================
...
# ========================================
# 15. Quadratic coefficients for SA and SI
...
# ========================================
# 16. Calculating the scores for SA and SI
#     SA = Sequential Amounts
#     SI = Sequential Intensity
# =========================================
def compute_scores_SASI(customers, features, coefs_SI, coefs_SA, T_max, file_scores_SASI):
    ...
    for (phi, phi_bar), customer in zip(features, customers):  
        ...
        # Weighting x the maximum amount
    ...
    with open(file_scores_SASI, "w") as f:
        f.write("matricule,x,y,nb_transactions\n")
        for customer, x, y  in zip(customers, list_x, list_y):  
            scores_SASI.append((x, y))
            f.write(customer.matricule + ",")
            f.write(f"{x:g},")
            f.write(f"{y:g},")
            f.write(f"{int(customer.nb_transactions)}\n")

    return scores_SASI

# =====================================================
# 17. Building the ARFF file associated with customers
...
def main():  
    ...
    parser = argparse.ArgumentParser(description="Example of customer segmentation using HMMs")
    ...
    parser.add_argument("--T_min", type=int, default=8, help="Minimum number of valid transactions.")
    ...
    features = train_hmms_customers(customers, initial_hmms, maxiter, minfloat, r, tolerance, file_hmm)
